...
const hilightMapping: HighlightMap = {
    ...
    FUNCTION_ATTR_PARENTIS_START: 'decorator',
    FUNCTION_ATTR_PARENTIS_END: 'decorator',
    FUNCTION_ARG_PARAMETER: 'parameter',
    FUNCTION_ARG_SEPARATOR: 'keyword',
    FUNCTION_ARG_PARENTIS_START: 'keyword',
    FUNCTION_ARG_PARENTIS_END: 'keyword',
    FUNCTION_NAME: ['function', 'declaration'],
    VARIABLE_ATTRIBUTE: 'decorator',
    VARIABLE_ATTR_SEPARATOR: 'decorator',
    VARIABLE_ATTR_PARENTIS_START: 'decorator',
    VARIABLE_ATTR_PARENTIS_END: 'decorator',
